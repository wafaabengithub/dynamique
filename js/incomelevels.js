...
$(document).ready(function() {
	...
	var incomeLevelTypes = ['low', 'average','high','very high'];
	...
	var fillColorFunction = new L.HSLHueFunction(new L.Point(0,90), new L.Point(3150,0));
	...
	var radiusFunction = new L.LinearFunction(new L.Point(0,7), new L.Point(3,10));
